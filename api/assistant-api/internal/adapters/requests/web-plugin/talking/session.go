...
func (talking *webpluginTalking) Disconnect() {
	ctx, span, _ := talking.
		Tracer().
...
func (talking *webpluginTalking) Connect(
	ctx context.Context,
...
func (talking *webpluginTalking) OnCreateSession(
	ctx context.Context,
...
func (talking *webpluginTalking) OnResumeSession(
	ctx context.Context,
	assistant *internal_assistant_entity.Assistant,
	identifier string,
