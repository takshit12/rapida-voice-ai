 ...
 */
import { SMALLEST_LANGUAGE, SMALLEST_MODEL } from '@/providers';
import { SetMetadata } from '@/utils/metadata';
import { Metadata } from '@rapidaai/react';

export const GetSmallestDefaultOptions = (current: Metadata[]): Metadata[] => {
  const mtds: Metadata[] = [];
...
export const ValidateSmallestOptions = (
  options: Metadata[],
): string | undefined => {
