...
import { GROQ_TEXT_MODEL } from '@/app/components/providers/text/groq/constants';
...
export const ConfigureGroqTextProviderModel: React.FC<{
  ...
  return (
    <div className="flex-1 flex items-center divide-x">
      <Dropdown
        ...
        currentValue={GROQ_TEXT_MODEL.find(
        ...
        allValue={GROQ_TEXT_MODEL}
        placeholder="Select model"
        option={c => {
          return (
            <span className="inline-flex items-center gap-2 sm:gap-2.5 max-w-full text-sm font-medium">
              <span className="truncate capitalize">{c.human_name}</span>
            </span>
          );
        }}
        label={c => {
      ...
      <div>
        ...
        >
          ...
          <FieldSet>
            ...
            />
            <InputHelper className="text-xs">
              How the model should select which tool to use when generating a
              response.
            </InputHelper>
          </FieldSet>
          ...
          <FieldSet className="col-span-2">
            ...
            <Textarea
              placeholder='Enter as JSON (e.g., {"type": "json_object"})'
              value={getParamValue('model.response_format') || ''}
              onChange={handleResponseFormat}
            />
            <InputHelper className="text-xs">
              Specifies the format for model output. Supports &quot;text&quot;
              or &quot;json_object&quot;.
            </InputHelper>
          </FieldSet>
        </Popover>
