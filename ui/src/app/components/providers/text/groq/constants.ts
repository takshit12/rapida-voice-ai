...
export const GROQ_TEXT_MODEL = [
  {
    ...
    human_name: 'GPT OSS 120B',
    description: 'OpenAI flagship open-weight MoE model, 131K context',
    category: 'text',
    status: 'ACTIVE',
  },
  {
    ...
    human_name: 'GPT OSS 20B',
    description: 'Fast OpenAI open-weight model, ~1000 T/s',
    category: 'text',
    status: 'ACTIVE',
  },
  {
  ...
  },
  {
    ...
    human_name: 'Llama 4 Scout 17B',
    description: 'Meta MoE model (109B total, 17B active), multimodal',
    category: 'text',
    status: 'ACTIVE',
  },
  {
    ...
    human_name: 'Llama 4 Maverick 17B',
    description: 'Meta large MoE model (128 experts), multimodal',
    category: 'text',
    status: 'ACTIVE',
  },
  {
    ...
    human_name: 'Kimi K2',
    description: 'Moonshot AI 1T MoE model, excels at tool use and coding',
    category: 'text',
    status: 'ACTIVE',
  },
  {
    ...
    human_name: 'Qwen 3 32B',
    description: 'Alibaba Qwen 3 model, 131K context, ~662 T/s',
    category: 'text',
    status: 'ACTIVE',
  },
  {
  ...
  },
  {
    ...
    human_name: 'Llama Guard 4 12B',
    description: 'Content safety and moderation model',
    category: 'text',
    status: 'ACTIVE',
  },
  {
    ...
    human_name: 'Safety GPT OSS 20B',
    description: 'OpenAI open-weight safety classification model',
    category: 'text',
    status: 'ACTIVE',
  },
  {
    ...
    description: 'Safety and moderation model (legacy)',
    category: 'text',
    status: 'ACTIVE',
  },
];
